...
public class Run {
	...
	public static void main (String[] args)  {
		...
		if (new File("/home/c/work/").exists() && (args == null || args.length == 0)) {
			args = "-directory /home/c/work/topicmodels/food2/ -method HMD -BURNIN_DOCUMENTS 10 -INIT_RAND 1 -T 100 -meta_params G(400) -MIN_DICT_WORDS 1 -RUNS 100 -TRAINING_SHARE 0.8".split(" ");
		}
