 ...
 */
    ...
    public class Triangle_dt : ICloneable
    {
        internal Point_dt a, b, c;
        internal Triangle_dt abnext, bcnext, canext;
        Circle_dt circum;
        internal int _mc = 0; // modcounter for triangulation fast update.

        internal bool halfplane = false; // true iff it is an infinite face.

        //	public boolean visitflag;
        internal bool _mark = false;   // tag - for bfs algorithms
        ...
        Triangle_dt neighbor(Point_dt p)
        {
            ...
            Console.WriteLine( "Error, neighbors can't find p: " + p );
            return null;
        }
